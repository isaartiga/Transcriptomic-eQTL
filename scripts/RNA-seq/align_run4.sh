...
PACKAGE=$PROJECT_HOME/20240318_Iraide_RNAseq/pDCs
REFERENCE_INDEX=/mnt/sdb/references/Genomes/Hg38/Gencode
OUTPUT=/mnt/sdb/projects/Iraide/MS_Iraide_Alloza_2023_10/RNA_seq/bams4
...
subread-align -t 0 -T 20  -i $REFERENCE_INDEX/GRCh38 -r $TRIMMED_P1 -R $TRIMMED_P2 -o $OUTPUT/$STAR_MAPPING_PREFIX.bam
